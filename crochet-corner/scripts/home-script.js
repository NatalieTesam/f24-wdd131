...
const ratingSorted = patterns.toSorted((a, b) => b.rating - a.rating);

// for the 3 most popular patterns populate the #home-page-pattern-output
const homePatternsSection = document.getElementById("home-page-pattern-output")
ratingSorted.forEach((element, index) => {
  if (index < 3) {
