...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardContainer = qs("#credit-card-container");
    const paypalContainer = qs("#paypal-container");
    ...
    theForm.elements.cardNumber.removeAttribute("required", "");
    theForm.elements.paypal.removeAttribute("required", "");
  
    // Show the container based on the selected payment method, and add the required attribute back.
    if (theForm.paymentMethod.value === "credit-card") {
      creditCardContainer.classList.remove("hide");
      theForm.elements.cardNumber.setAttribute("required", "");
    }
    else if (theForm.paymentMethod.value === "paypal") {
      paypalContainer.classList.remove("hide");
      theForm.elements.paypal.setAttribute("required", "");
    }
  }
  ...
  qs("#payment-method").addEventListener("change", togglePaymentDetails)
